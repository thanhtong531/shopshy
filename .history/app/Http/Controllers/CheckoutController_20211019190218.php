...
class CheckoutController extends Controller
{
    ...
    public function order_place(Request $request)
    {
        ...
        $order_data = array();
        $order_data['order_id'] = Session::get('customer_id');
        $order_data['product_id'] = Session::get('shipping_id');
        $order_data['product_name'] = $payment_id;
        $order_data['product_price'] = Cart::total();
        $order_data['product_sale_quantity'] = 'Đang chờ xử lý';
        $order_id = DB::table('tbl_order')->insertGetId($order_data);
