...
<section class="payment checkout-payment">
    <div class="container">
        <div class="payment-top">
            ...
            <p class="payment-name">Chọn hình thức thanh toán</p>
            <form action="{{URL::to('/order-place')}}" method="post">
                {{csrf_field()}}
                <div class="payment-option">
                    <div class="pay">
                        <label><input type="checkbox" name="payment-option" value="ATM" id=""><p class="payment-desc">Thanh Toán qua ATM </p></label>
                    </div>
                    <div class="pay">
                        <label><input type="checkbox" name="payment-option" value="tien_mat" id=""><p class="payment-desc">Thanh Toán Tiền Mặt</p></label>
                    </div>
                    <input type="submit" value="Đặt hàng" name="send_order_place" class="btn-primary btn-sm button-order">
                </div>
            </form>
