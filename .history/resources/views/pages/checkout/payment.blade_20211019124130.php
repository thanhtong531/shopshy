    ...
    <div class="container">
        <div class="payment-top">
            ...
            <div class="payment-option">
                <span class="pay">
                    <label><input type="checkbox" name="payment-option" value="1" id=""><span class="payment-title">Thanh Toán qua ATM </span></label>
                </span>
                <span class="pay">
                    <label><input type="checkbox" name="payment-option" value="2" id=""><span class="payment-title">Thanh Toán Tiền Mặt</span></label>
                </span>
            </div>
