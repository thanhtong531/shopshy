    ...
    <div class="wrapper">
        ...
        <header class="header">
            <div class="container">
                <div class="header-top">
                    ...
                    <div class="search">
                            {{ csrf_field() }}
                            <input type="text" name="keywords_submit" class="search-input" placeholder="Search..."> 
                            <input type="submit" name="search-items" value="Tìm kiếm" class="button-submit" />
                            
                        </div>
                    </form>
                    <ul class="menu">
                        <li class="menu-item">
                            <a href="{{URL::to('/trangchu')}}" class="menu-link">
                        ...
                        <li class="menu-item">
                            <a href="" class="menu-link">
                                ...
                                <?php 
                                    ...
                                    if($customer_id != NULL){
                            ?>
                                <li class="menu-item"><a class="menu-link" href="{{URL::to('/logout-checkout')}}" class="signup">
                                    <ion-icon name="log-out"></ion-icon>
                                    Đăng xuất</a></li>
                                <?php }else{
                                ?>
                                <li class="menu-item"><a href="{{URL::to('/login-checkout')}}" class="menu-link"> Đăng nhập </a></li>
                        ...
                        <?php 
                            ...
                            ?>
                                <li class="menu-item"><a class="menu-link" href="{{URL::to('/checkout')}}" class="signup"><ion-icon name="wallet"></ion-icon>Thanh toán</a></li>
                                <?php }elseif($customer_id != NULL && $shipping_id != NULL){
                                ?>
                                 <li class="menu-item">
                                    <a href="{{URL::to('/payment')}}" class="menu-link">
                                ...
                                <li class="menu-item">
                                    <a href="{{URL::to('/login-checkout')}}" class="menu-link">
                                        <ion-icon name="wallet"></ion-icon>
                                        Thanh toán
                                    </a>
                                </li>
                        ...
                        <li class="menu-item">
                            <a href="{{URL::to('show-cart')}}" class="menu-link">
        ...
        <div class="main">
            <div class="category">
                <div class="container">
                    <div class="nav-title">
                        <p class="nav-name">Danh mục sản phẩm</p>
