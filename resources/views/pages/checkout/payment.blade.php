        ...
        <div class="payment-top">
            ...
            <form action="{{URL::to('/order-place')}}" method="POST">
                ...
                <div class="payment-option">
                    <div class="pay">
                        <label><input type="checkbox" name="payment_option" value="1" id=""><p class="payment-desc">Thanh Toán qua ATM </p></label>
                    </div>
                    <div class="pay">
                        <label><input type="checkbox" name="payment_option" value="2" id=""><p class="payment-desc">Thanh Toán Tiền Mặt</p></label>
                    </div>
